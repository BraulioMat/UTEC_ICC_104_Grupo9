...
paises = input('Ingrese lista de paises:').replace('[','').replace(']','').replace(' ','').split(',')
edge = {}
...
#No se como imprimir sin usar colab, entonces aca estan las variables de las graphicas para ver
h
g
